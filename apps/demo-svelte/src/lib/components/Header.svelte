...
<header class="border-b-4 border-border bg-background">
  <div
  ...
  >
    <div class="flex items-center space-x-6">
      ...
      >
        <span class="font-['Rubik_Wet_Paint'] text-2xl text-primary leading-8">
          Slop Machine
        </span>
        <span
          class="hidden sm:inline-block bg-secondary text-primary-foreground text-[0.65rem] font-medium px-2 py-0.5 rounded-sm border border-transparent align-middle leading-4"
        >
          For Developers
        </span>
      </a>
