...
export const simpleVersionedExampleShareId = "AMwjJQdlUF";
export const managedExampleBucketId = "fFzg3gpfI03VdjTekcQd";
export const managedExampleShareId = "5Ns-g8ncdL";
export const proceduralExampleBucketId = "0Risb3L5eS76tidF3ug9";
export const proceduralExampleShareId = "2sut73TskA";
export const videoExampleBucketId = "i7ydY0005DyuXyUgj7tl";
export const videoExampleShareId = "G619CCZaKQ";
export const textExampleBucketId = "A4arl0ziUSIbrUBFsQSO";
export const textExampleShareId = "Oo58MWoW32";
